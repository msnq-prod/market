...
Stones — full-stack система для работы с уникальными камнями: от постановки задачи на сбор и приемки партии до публичной витрины, заявки на покупку и цифрового паспорта конкретного экземпляра.
...
- `VITE_VIDEO_HELPER_DOWNLOAD_URL=https://downloads.example.com/Stones-Video-Helper.dmg`
