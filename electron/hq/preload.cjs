...
contextBridge.exposeInMainWorld('stonesDesktop', {
    ...
    stageMediaQueueFileDiscard: (fileId) => ipcRenderer.invoke('stones:media-stage-file-discard', fileId),
    ...
    completePhotoApplyWorkflowStaging: (workflowId) => ipcRenderer.invoke('stones:complete-photo-apply-workflow-staging', workflowId),
