# Полный пакет документации Stones

Актуально на 14.04.2026.

Этот документ собирает весь комплект документации по системе Stones в одном месте и показывает:
...
Документ опирается на фактическое состояние текущего репозитория, а не на целевую модель "на будущее".
