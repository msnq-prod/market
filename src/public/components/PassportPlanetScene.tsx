    ...
    return (
        <group position={position}>
            <Html center style={{ pointerEvents: 'none' }}>
                <div className="relative select-none" style={{ width: '0px', height: '0px', transform: 'translateY(184px)' }}>
                    <div className="absolute left-[-258px] top-0 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full border border-black/35 bg-white shadow-[0_0_18px_rgba(255,255,255,0.85)]" />
                    <div className="absolute left-[-257px] top-[-2px] h-px w-[34px] origin-left rotate-[-46deg] bg-white/90" />
                    <div className="absolute left-[-232px] top-[-19px] h-px w-[218px] bg-white/90" />

                    <div className="absolute left-[-232px] top-[-66px] max-w-[230px] text-[13px] font-semibold leading-[1.08] text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)] [text-wrap:balance]">
                        {displayName}
                    </div>

                    <div className="absolute left-[-184px] top-[-9px] font-mono text-[10px] tracking-[0.16em] text-white/74 drop-shadow-[0_2px_10px_rgba(0,0,0,0.4)]">
                        {coordinatesLabel}
                    </div>
                </div>
            </Html>
            ...
            {hasLocation ? (
                <div className="absolute left-[32%] top-[68%]">
                    <div className="relative">
                        ...
                        <div className="absolute left-[8px] top-[-3px] h-px w-[26px] origin-left rotate-[-40deg] bg-white/90" />
                        <div className="absolute left-[28px] top-[-20px] h-px w-[190px] bg-white/90" />
                    </div>
                    <div className="ml-7 mt-[-4.25rem] max-w-[230px] text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)]">
                        <div className="text-[13px] font-semibold leading-[1.08] [text-wrap:balance]">
                            {locationName || 'Локация сбора'}
                        </div>
                        {coordinatesLabel ? (
                            <div className="mt-6 font-mono text-[10px] tracking-[0.16em] text-white/74">
                                {coordinatesLabel}
                            </div>
                        ) : null}
                    </div>
