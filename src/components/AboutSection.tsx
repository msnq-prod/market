...
export function AboutSection() {
    return (
        <section id="about" className="relative z-10 w-full min-h-[50vh] border-t border-white/10 bg-black/90 px-4 py-14 text-white backdrop-blur-md pointer-events-auto sm:px-6 md:py-20">
